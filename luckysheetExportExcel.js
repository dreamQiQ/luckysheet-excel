  ...
  cellArr.forEach(function (row, rowid) {
    ...
    row.every(function (cell, columnid) {
      ...
      if (rowid == 0) {
        ...
        //设置单元格列宽除以8
        dobCol.width = window.luckysheet.getColumnWidth([columnid])[columnid] / 8
      }
...
var fontConvert = function (ff = 0, fc = '#000000', bl = 0, it = 0, fs = 10, cl = 0, ul = 0) {
  ...
  let color = fc ? (fc.includes('rgb') ? rgb2hex(fc) : fc) : '#000000'
...
export { setStyleAndValue, setMerge, setBorder, setImages, saveFile }
